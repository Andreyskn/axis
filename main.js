/*
  фокусить инпуты не обязательно
*/
...
function congratulate() {
  var text = "Пример решен правильно! Нажмите пробел для обновления";
  var textField = document.createElement("span");
  textField.id = 'congrats';
  document.body.style.padding = 0;
  textField.innerHTML = text;
  document.body.insertBefore(textField, numbers);
}